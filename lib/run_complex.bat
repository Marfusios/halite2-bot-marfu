...
python .\client.py gym -r "dotnet ..\artefacts\marfu\BotMarfu.dll" -r "dotnet ..\artefacts\opponent_v10\BotMarfu.dll" -r "dotnet ..\artefacts\opponent_v6\BotMarfu.dll" -r "dotnet ..\artefacts\opponent_v5\BotMarfu.dll" -b "..\halite.exe" -i 30 -W 240 -H 160 -id "v16" -desc "vs v10 v6 v5"
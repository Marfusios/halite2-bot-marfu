...
halite.exe -d "240 160" -s 3659024236 "dotnet artefacts\marfu2\BotMarfu.dll" "dotnet artefacts\opponent_v6\BotMarfu.dll" -t
...
halite.exe -d "312 208" -s 820500439 "dotnet artefacts\marfu2\BotMarfu.dll" "dotnet artefacts\opponent_v6\BotMarfu.dll" -t
